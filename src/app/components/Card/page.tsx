...
const Page: React.FC<CardProps> = ({ label, src, alt, width, height }) => {
    return (
        <div className="bg-blue-200 md:mx-5 mt-24 border-2 rounded-lg border-blue-200">
            <h1 className="text-[19px] font-normal pr-2 md:mt-24 ml-10">{label}</h1>
            <Image className="md:mx-28 md:my-14 flex flex-row flex-none items-center" src={src} alt={alt} width={width} height={height} />
