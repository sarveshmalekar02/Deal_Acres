...
if(storedRole === 'commercial'){
        switch (selectedUser) {
            ...
            case 'agent':
                ...
                break;
            case 'builder':
                router.push('/components/PropertyProfile'); 
                break;
            default:
            ...
            switch (selectedUser) {
                case 'owner':
                    router.push('/Plot/PropertyProfile');
                    break;
                default:
                ...
                toast.error('No valid role found in Local Storage');
        }
                            ...
                            <div className='mb-6'>
                                ...
                                {(selectedUser === 'agent') && (
                                    <div>
                                        ...
                                        <input className="hover:border-blue-600 border-4 border-blue-100 mt-1 px-4 py-2 rounded-lg mb-4 w-full" type="tel" placeholder="Full address" />
                                    </div>)}
